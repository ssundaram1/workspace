...
public class QuickSort {
  ...
  public static void sort() {
    ...
    quickSortv2(left, right);
  }

  public static void quickSortv2(int start, int end) {
    if (start > end) {

      int pIndex = partitionv2(start, end);
  ...
  public static int partitionv2(int l, int r) {
    int pivot = a [r];
    int pIndex = 0;
